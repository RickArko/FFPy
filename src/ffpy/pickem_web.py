...
def _public_auth_config(auth_enabled: bool, request: Optional[Request] = None) -> Dict[str, Any]:
    ...
    auth_redirect_url = f"{public_app_url}/pickem/"
    return {
...
def create_app(
    ...
    *,
    ...
    def auth_config(request: Request) -> Dict[str, Any]:
        return _public_auth_config(auth_enabled, request)
